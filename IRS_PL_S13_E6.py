...
"""
WT32-ETH01 v1.4
LAN DHCP Starvation Attack

https://docs.micropython.org/en/latest/library/network.html
https://mpython.readthedocs.io/en/latest/library/micropython/network.html

Prompt: Write a script in MicroPython to connect 255 times to a LAN with a WT32-ETH01. Change the MAC address of the WT32-ETH01. Change the IP address of the WT32-ETH01.
"""
...
# Main
print("LAN DHCP Starvation Attack")
print()
...
for i in range(1, 255, 1):
    ...
    mac_hexadecimal = "18F6830000" + '{:02x}'.format(i)
